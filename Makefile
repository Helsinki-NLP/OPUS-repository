...
##  data in repositories but has no DB of its own.
##
## install-client:  Install only the repository software so the sge/slurm client
...
##  not funcional and obsolete at this point
